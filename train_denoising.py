...
def main():
    ...
    parser.add_argument('--randomcrop_darkshading', action='store_true')
    parser.add_argument('--darkframe_num', default=400, type=int)
    parser.add_argument('--use_realdarkshading', action='store_true')
    
    
    parser.add_argument('--darkshading_folder', default='', type=str)
    parser.add_argument('--darkframe_folder', default='', type=str)
    parser.add_argument('--hot_darkshading_folder', default='', type=str)
    parser.add_argument('--hot_darkframe_folder', default='', type=str)
    
    parser.add_argument('--preload_files', action='store_true')
    ...
    parser.add_argument('--save_epoch_freq', default=30, type=int)
    parser.add_argument('--test_freq', default=100, type=int) #100
    parser.add_argument('--save_folder', default='./logs/denoising/weights', type=str)
