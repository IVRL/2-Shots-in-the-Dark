"""
modified from https://github.com/cydonia999/Learning_to_See_in_the_Dark_PyTorch/blob/master/models/lsid.py
"""
...
# -----------------------------------
class LSID_RGB(nn.Module):
    def __init__(self, args):
        super(LSID_RGB, self).__init__()
        inchannel=3
        block_size=2
